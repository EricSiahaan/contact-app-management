...
import { getTestContact, removeAllTestAddresses, removeAllTestContacts, removeTestUser, createTestUser, createTestContact, createTestAddress, getTestAddress } from "./test-util";
...
describe('DELETE /api/contacts/:contactId/addressees', function () {
    beforeEach(async () => {
        await createTestUser();
        await createTestContact();
        await createTestAddress();
